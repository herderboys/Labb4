...
// void inmatning_och_print_first( BinarySearchTree &t, BinarySearchTree &t2 )
// {
//   t = BinarySearchTree(5);
//   t.l_children() = BinarySearchTree(4);
//   t.r_children() = BinarySearchTree(7);
//   t.l_children().l_children() = BinarySearchTree(1);
//   t.l_children().l_children().r_children() = BinarySearchTree(3);
//
//   t.r_children().l_children() = BinarySearchTree(6);
//   t.r_children().r_children() = BinarySearchTree(8);
//   t.r_children().r_children().r_children() = BinarySearchTree(9);
//
//   t2 = t;
//   t2.print_out(); std::cout << std::endl;
//   if ( t == t2 )
//     std::cout << "LIKA" << std::endl;
//   else
//     std::cout << "OLIKA" << std::endl;
//
//   t2.r_children().r_children().l_children() = BinarySearchTree(7);
//   if ( t == t2 )
//     std::cout << "LIKA" << std::endl;
//   else
//     std::cout << "OLIKA" << std::endl;
